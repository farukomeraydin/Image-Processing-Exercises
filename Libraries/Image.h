...
public:
    ...
    Image ThresholdFunc(int th);
    Image CreateGrayScaleImage(void);
    Image RescaleSize(Image input, float scale);

    Image NegativeTransform(Image input);
    Image LogTransform(Image input);
    Image GammaCorrection(Image input, float gamma);
    Image AveragingFilter(Image input, int squareMaskSize);
    Image MedianFilter(Image input);

    Image HistogramEqualization(Image input);
    Image Mask3x3(Image input, float m00, float m01, float m02, float m10, float m11, float m12, float m20, float m21, float m22);
    Image GaussianFilter5x5(Image input, float k);

    Image FT(Image input);
    Image Abs(Image input);
    Image IFT(Image input);

    Image Scale(Image input);
    Image Absolute(Image input);
